...
//Este es lo que sacamos del modelo RDL que usamos
package cfs_aligner_ral_pkg;
    ...
    class cfs_aligner_regs__ctrl extends uvm_reg;
        ...
        virtual function void build();
            ...
            this.offset.configure(this, 2, 7, "RW", 1, 'h0, 1, 1, 0);
            this.reserved1 = new("reserved1");
            this.reserved1.configure(this, 6, 9, "RO", 0, 'h0, 1, 1, 0);
            this.clr = new("clr");
            this.clr.configure(this, 1, 15, "WO", 1, 'h0, 1, 1, 0);
        endfunction : build
    endclass : cfs_aligner_regs__ctrl
    ...
    endclass : cfs_aligner_regs__status
    ...
    endclass : cfs_aligner_regs__irqen
    ...
    endclass : cfs_aligner_regs__irq
